...
def reset_global_workspace_buffer() -> None:
    """Drop the flashinfer workspace so the next wrapper allocates a fresh one."""
...
class FlashInferAttnBackend(AttentionBackend):
    ...
    def __init__(
        ...
        # Allocate buffers
        global global_workspace_buffer
        bump = getattr(model_runner, 'vram_mgr', None)
