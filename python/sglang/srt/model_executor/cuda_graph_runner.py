...
class DecodeInputBuffers(ForwardInputBuffers):
    ...
    def create(
        ...
        *,
        ...
        def _alloc(shape, dtype, fill_value=0):
        ...
        with torch.device(device):
            ...
            seq_lens = _alloc((max_bs,), torch.int32, fill_value=seq_len_fill_value)
            ...
            custom_mask = _alloc(((max_bs * seq_len_fill_value + max_num_token) * num_tokens_per_bs,), torch.bool, fill_value=1)
...
class CudaGraphRunner:
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        self.buffers: DecodeInputBuffers = DecodeInputBuffers.create(
            device=self.device,
            max_bs=self.max_bs,
            bump_manager=self.model_runner.vram_mgr,
    ...
    def _capture_graph(self, graph, pool, stream, run_once_fn):
        ...
        graph_fn = (
            partial(memory_saver_adapter.cuda_graph, tag=f"cuda_graph:{self.model_runner.server_args.served_model_name}")
